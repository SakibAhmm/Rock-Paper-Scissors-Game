...
function playerMove(playerPick) {
  ...
  document.querySelector(
    ".js-moves"
  ).innerHTML = `<div class="result-popout1">You</div> <img src="Images/${playerPick}-icon.png" class="move-icon1">
...
function pickComputerMove() {
  // Function i created for every Rock Paper Scissor computers Move
...
function removeButton() {
  document.getElementById("moves-icon-p").innerHTML = "";
